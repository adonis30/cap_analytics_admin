...
import {
  ...
  useGetInvestmentAskQuery, // ✅ NEW HOOK
} from "state/api";
  ...
  return (
    <Box mb={4} m="1.5rem 2.5rem">
      ...
      <Box mt={6} display="flex" justifyContent="space-between" alignItems="center" mb={2}>
        ...
        <Button variant="contained" color="primary" onClick={() => handleCreate("investmentask")}>
          Create Investment Ask
        </Button>
      </Box>
      <Tools data={investmentAsks} type="investmentask" loading={loadingInvestmentAsks} />
